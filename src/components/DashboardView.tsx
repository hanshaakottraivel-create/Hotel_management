      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-xs font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all shadow-xs"
          >
      ...
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
          ...
          <button
            ...
            className="text-xs text-indigo-600 font-semibold hover:text-indigo-700 flex items-center gap-1 self-start sm:self-auto"
          >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div
            onClick={() => setCurrentTab("rooms")}
            className="p-3.5 rounded-xl border border-emerald-200 bg-emerald-50/50 hover:bg-emerald-50 cursor-pointer transition-colors"
          >
            <div className="flex items-center justify-between">
          ...
          <div
            onClick={() => setCurrentTab("rooms")}
            className="p-3.5 rounded-xl border border-blue-200 bg-blue-50/50 hover:bg-blue-50 cursor-pointer transition-colors"
          >
            <div className="flex items-center justify-between">
          ...
          <div
            onClick={() => setCurrentTab("rooms")}
            className="p-3.5 rounded-xl border border-amber-200 bg-amber-50/50 hover:bg-amber-50 cursor-pointer transition-colors"
          >
            <div className="flex items-center justify-between">
          ...
          <div
            onClick={() => setCurrentTab("rooms")}
            className="p-3.5 rounded-xl border border-rose-200 bg-rose-50/50 hover:bg-rose-50 cursor-pointer transition-colors"
          >
            <div className="flex items-center justify-between">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 self-end sm:self-auto">
                        ...
                        {booking.status === "Checked-In" ? (
                          <span className="px-3 py-1.5 rounded-xl bg-slate-100 text-slate-600 text-xs font-semibold flex items-center gap-1">
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold transition-colors shadow-xs"
                          >
                            Check-In
                          </button>
                        )}
                    ...
                    <div className="flex items-center gap-2 self-end sm:self-auto">
                      {booking.status === "Checked-Out" ? (
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-xs font-semibold transition-colors shadow-xs"
                        >
                          Check-Out & Settle
                        </button>
                      )}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-indigo-900 via-slate-900 to-slate-950 text-white p-5 rounded-2xl border border-indigo-800/60 shadow-md">
            ...
            <div className="mt-4 space-y-2">
              <button
                onClick={() => setIsAiDrawerOpen(true)}
                className="w-full text-left p-2.5 rounded-xl bg-white/10 hover:bg-white/15 border border-white/10 text-xs text-slate-200 transition-colors flex items-center justify-between"
              >
