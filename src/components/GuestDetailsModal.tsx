  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="p-4 sm:p-5 overflow-y-auto space-y-4 flex-1">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-3 text-center">
            <div className="p-2.5 sm:p-3 bg-slate-50 rounded-xl border border-slate-100">
              ...
              <div className="text-xs sm:text-sm font-bold text-slate-900 mt-0.5">{guest.totalVisits} visits</div>
            </div>
            <div className="p-2.5 sm:p-3 bg-slate-50 rounded-xl border border-slate-100">
              <span className="text-[10px] text-slate-400 uppercase font-semibold">Lifetime Spend</span>
              <div className="text-xs sm:text-sm font-bold text-slate-900 mt-0.5">${guest.totalSpend.toLocaleString()}</div>
            </div>
            <div className="p-2.5 sm:p-3 bg-slate-50 rounded-xl border border-slate-100">
              <span className="text-[10px] text-slate-400 uppercase font-semibold">Last Visited</span>
              <div className="text-xs sm:text-sm font-bold text-slate-900 mt-0.5 truncate">{guest.lastVisit || "Recent"}</div>
            </div>
          </div>
          ...
          <div className="p-3.5 bg-white rounded-xl border border-slate-200 text-xs space-y-1.5 text-slate-600">
            <div className="flex items-center gap-2">
              ...
              <span className="truncate">Email: <strong className="text-slate-900">{guest.email}</strong></span>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="p-4 rounded-xl border border-indigo-200 bg-indigo-50/50 space-y-3">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              ...
              <button
                ...
                className="w-full sm:w-auto min-h-[38px] px-3 py-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white text-xs font-semibold flex items-center justify-center gap-1 transition-colors"
              >
            ...
            <div className="flex items-center gap-2">
              <select
                ...
                className="w-full text-xs py-2 px-2.5 min-h-[40px] rounded-lg border border-indigo-200 bg-white text-slate-800"
              >
              ...
              <div className="bg-white p-3 rounded-xl border border-indigo-100 text-xs space-y-2">
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className="min-h-[36px] px-3 py-1.5 rounded-lg bg-slate-900 hover:bg-slate-800 text-white font-semibold text-[11px]"
                  >
                    Copy Letter
                  </button>
                </div>
              ...
              <div className="space-y-1.5">
                {guestBookings.map((b) => (
                  <div
                    ...
                    className="p-3 rounded-xl bg-slate-50 hover:bg-slate-100 active:bg-slate-200 border border-slate-200 flex items-center justify-between cursor-pointer transition-colors"
                  >
                    <div>
        ...
        {/* Footer */}
        <div className="p-4 border-t border-slate-200 bg-slate-50 flex flex-col sm:flex-row items-center justify-between gap-2 shrink-0">
          <button
            onClick={() => {
              setSelectedGuestId(null);
              setIsNewBookingOpen(true);
            }}
            className="w-full sm:w-auto min-h-[42px] px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white text-xs font-semibold flex items-center justify-center gap-1.5 shadow-xs"
          >
          ...
          <button
            onClick={() => setSelectedGuestId(null)}
            className="w-full sm:w-auto min-h-[42px] px-4 py-2 rounded-xl border border-slate-200 text-xs font-semibold text-slate-700 hover:bg-white active:bg-slate-100"
          >
            Close
          </button>
        </div>
