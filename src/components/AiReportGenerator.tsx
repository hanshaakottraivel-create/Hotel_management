        ...
        {report && (
          <div className="flex items-center gap-2 self-start md:self-auto">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/10 hover:bg-white/20 border border-white/10 text-xs font-semibold text-white transition-colors"
      ...
      <div className="p-5 bg-slate-50 border-b border-slate-200 space-y-4">
        ...
        <div className="pt-2 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-t border-slate-200/80">
          ...
          <button
            ...
            disabled={isLoading}
            className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-xs transition-all shadow-xs disabled:opacity-50"
          >
            {isLoading ? (
              <>
